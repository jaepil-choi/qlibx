...
**작성 2026-09-02 · 갱신 2026-09-05.** 이 디렉터리에 86개 파일이 있고 **82개가 닫혔다.** 닫힌 파일을 옮기지 않는
...
## 1. 열린 것 — 넷 (`023`·`027` + 실환경 `082`·`086`; `078`은 record `155`, `079`·`083`·`084`·`085`는 `156`, `080`·`081`은 `157`이 닫았다)
