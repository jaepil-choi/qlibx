...
**작성 2026-09-02 · 갱신 2026-09-02.** 이 디렉터리에 52개 파일이 있고 **47개가 닫혔다.** 닫힌 파일을 옮기지 않는
...
> **이 디렉터리는 이슈 목록으로 닫히지 않는다.** 열린 다섯 중 하나(`034`)는
> 별개의 결손이 아니라 아키텍처에 세 개의 명사(**Panel · Surface · Run**)가 없어서
