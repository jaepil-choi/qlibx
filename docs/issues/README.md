...
**작성 2026-09-02 · 갱신 2026-09-05.** 이 디렉터리에 87개 파일이 있고 **85개가 닫혔다.** 닫힌 파일을 옮기지 않는
...
## 1. 열린 것 — 둘 (`023`·`087`; `078`은 record `155`, `079`·`083`·`084`·`085`는 `156`, `080`·`081`은 `157`, `086`은 `158`, `027`·`082`는 `160`이 닫았다)
...
| `087` | 끝난 run이 occurrence마다 parquet 파일 하나를 남긴다 — 표 하나가 8 KB짜리 607개 | **열림 2026-09-07.** 두 0.4.1 workspace 실측(한 run이 19,452 파일·155 MB). 소유자 판정: `release()`에서 compaction, 죽은 run은 part 유지. 리포팅 API 뒤 별도 브랜치 | 기록 layout (`docs/design/run-record-layout.md`) |
