...
Internal-transition: this is the physical home of the component loading authority as of G002.
`vqapr.extension.loading` is a temporary forwarding adapter over this module until G004 hard
deletion; do not add new logic to the adapter.
"""
