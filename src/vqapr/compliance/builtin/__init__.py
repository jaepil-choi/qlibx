...
because ``extension/loading.py`` re-executes a component file by path under a fingerprinted module
...
from vqapr.compliance.builtin.no_short import NoShort
from vqapr.compliance.builtin.single_name_cap import SingleNameCap
...
__all__ = ["SHIPPED_COMPLIANCE", "NoShort", "SingleNameCap", "shipped_compliance_path"]
