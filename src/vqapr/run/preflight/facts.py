...
(`derived_agenda`), the execution table bound to the run's window (`bound_execution_table`) and the
horizon that table gives (`bound_execution_horizon`). What those facts leave unresolved -- a
